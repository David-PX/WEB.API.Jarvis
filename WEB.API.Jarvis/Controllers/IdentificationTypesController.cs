...
namespace WEB.API.Jarvis.Controllers
{
    ...
    public class IdentificationTypesController : ControllerBase
    {
        ...
        {
            string methodName = "GetIdentification Types";
        ...
        public async Task<IActionResult> PutIdentificationType(Guid id, IdentificationType identificationType)
        {
            ...
            {
                LoggerService.LogException(methodName, Request, "Identification Type Bad Request", startTime);
                LoggerService.LogActionEnd(methodName, startTime);
                return StatusCode(StatusCodes.Status404NotFound,
                                    new Response
                                    {
                                        Status = "Bad Request",
                                        Message = "The ID of Identification Type are not the same"
                                    }
                    );
            }
            ...
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                else
                {
                    ...
                    return StatusCode(StatusCodes.Status409Conflict,
                                        ...
                                        {
                                            Status = "Not found",
                                            Message = "Identification Type Conflict With Db Exception"
                                        }
                        );
                }
            }
            ...
            return StatusCode(StatusCodes.Status200OK,
                                ...
                                {
                                    Status = "Ok",
                                    Message = "Identification Type Updated Sucessfully"
                                }
                );
        }
        ...
        public async Task<ActionResult<IdentificationType>> PostIdentificationType(IdentificationType identificationType)
        {
            ...
            if (_context.IdentificationTypes == null)
            {
                ...
                return StatusCode(StatusCodes.Status406NotAcceptable,
                                    ...
                                    {
                                        Status = "Bad Request",
                                        Message = "The Identification Type was not send"
                                    }
                    );
            }
            ...
            return StatusCode(StatusCodes.Status201Created,
                                ...
                                {
                                    Status = "Created",
                                    Message = "Identification Type Created Sucessfully"
                                }
                );
        }
        ...
        public async Task<IActionResult> DeleteIdentificationType(Guid id)
        {
            ...
            return StatusCode(StatusCodes.Status202Accepted,
                                ...
                                {
                                    Status = "Deleted",
                                    Message = "Identification Type Deleted Sucessfully"
                                }
                );
        }
