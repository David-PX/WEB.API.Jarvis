                        ...
                        <div style=""max-width: 600px; margin: 0 auto;"" class=""email-container"">
                          ...
                          <table align=""center"" role=""presentation"" cellspacing=""0"" cellpadding=""0"" border=""0"" width=""100%"" style=""margin: auto;"">
                              ...
                              <td valign=""middle"" class=""hero bg_white"" style=""padding: 3em 0 2em 0;"">
                                <img src=""https://i.postimg.cc/pmQBBj92/jarvis.png"" alt="""" style=""width: 300px; max-width: 600px; height: auto; margin: auto; display: block;"">
                              </td>
	                          </tr><!-- end tr -->
				                    <tr>
            	                    ...
            	                    <tr>
            		                    <td>
            			                    <div class=""text"" style=""padding: 0 2.5em; text-align: center;"">
                                                <h3>Bienvenido {userNames}</h3>
            				                    <h4>Verifica tu correo electronico en el siguiente boton</h2>

                                                <h4>En tu siguiente inicio de sesion utiliza la siguiente contraseña</h4>
            				                    <b>{provisionalPwd}</b>
            				                    <p><a href=""{confirmationLink}"" class=""btn btn-primary"">Verificar</a></p>
            			                    </div>
            		                    </td>
            	                    </tr>
                                </table>
