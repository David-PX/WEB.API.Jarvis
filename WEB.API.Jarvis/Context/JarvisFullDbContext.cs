...
public partial class JarvisFullDbContext : DbContext
{
    ...
    public virtual DbSet<PensumSubject> PensumSubjects { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PensumId).HasName("PK__Pensum__225B95C2F34A6CF1");

            entity.ToTable("Pensum");

            entity.Property(e => e.PensumId)
                .ValueGeneratedNever()
                .HasColumnName("PensumID");
            entity.Property(e => e.CarrerId).HasColumnName("CarrerID");
            entity.Property(e => e.PensumName)
                .HasMaxLength(30)
                .IsUnicode(false);

            entity.HasOne(d => d.Carrer).WithMany(p => p.Pensums)
                .HasForeignKey(d => d.CarrerId)
                .HasConstraintName("FK_Pensum.CarrerID");
        });
